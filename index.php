		  ...
		  <div class="container-fluid">
		    ...
		    <div class="collapse navbar-collapse" id="navbarSupportedContent">
		      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
				...
				<li class="nav-item">
		          <a class="nav-link" href="Application.php">For Students</a>
        	...
        	<div class="card mb-3 card-1">
			  <div class="row g-0">
			    <div class="col-md-4">
			      ...
			      <img src="logo1.jpg" width="1000" class="img-fluid rounded-start" >
			    ...
			    <div class="col-md-8">
			      <div class="card-body">
			       ...
			       <p class="card-text"><?=$setting['about']?></p> 
			        <p class="card-text"><small class="text-muted">Foka STEMPower</small></p>
